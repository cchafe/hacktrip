...
//  if (argc < 3 || argc > 7 ) usage();
  ...
  // Set the same number of channels for both input and output.
  unsigned int bufferFrames = 128; // min 64 for pw
  RtAudio::StreamParameters iParams, oParams;
  ...
  std::cout << "\niParams.deviceId = " << iParams.deviceId << std::endl;
  std::cout << "\noParams.deviceId = " << iParams.deviceId << std::endl;
  try {
